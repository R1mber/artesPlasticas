...
import {Button, StatusBar, StyleSheet, Text, View, Image, ScrollView, TouchableOpacity} from 'react-native';
      ...
      {loading ? (
        ...
        <View style={styles.container}>
          ...
          <ScrollView style={styles.body}>
            {temas.map(tema => {
              return <Card navigation={navigation} key={tema.id} tema={tema} />;
            })}
